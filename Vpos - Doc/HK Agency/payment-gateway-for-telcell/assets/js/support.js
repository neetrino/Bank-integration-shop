!function () {
    ...
    const l = () => {
        const t = (0, i.getSetting)("hkd_telcell_data", null);
        if (!t) throw new Error("Telcell initialization data is not available");
        return t
    };
    var o;
    ...
    (0, n.registerPaymentMethod)({
        ...
        ariaLabel: (0, a.__)("Telcell payment method", "hkd_telcell"),
        canMakePayment: () => !0,

...
$taxServiceReport = get_post_meta($order->get_id(), 'TaxServiceReturnReport', true);
$taxServicePrintReport = get_post_meta($order->get_id(), 'TaxServiceReport', true);
$taxServicePrintReportDecoded = json_decode($taxServicePrintReport, true);
...
if (!function_exists('get_http_response_code_refund')) {
    function get_http_response_code_refund($url)
    {
...
if (get_http_response_code_refund('https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=' . str_replace(' ', '', esc_html($taxServiceReportDecoded['qr']))) != "200") {
    if (get_http_response_code_refund('https://quickchart.io/chart?cht=qr&chs=300x300&chl=' . str_replace(' ', '', esc_html($taxServiceReportDecoded['qr']))) != "200") {
    ...
    <div class="card mt-3"
        ...
        <div class="card-header"
            ...
            ԿՏՐՈՆԻ ՖԻՍԿԱԼ ՀԱՄԱՐ <strong
                    style="box-sizing: border-box;font-weight: bolder;"><?php echo esc_html($taxServicePrintReportDecoded['fiscal']) ?></strong>
        ...
        <div class="card-body" style="box-sizing: border-box;-ms-flex: 1 1 auto;flex: 1 1 auto;padding: 1.25rem;">
            <div class="row mb-5"
                ...
                <div class="mt-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"
                    ...
                    <div style="box-sizing: border-box;">Կայք՝ <strong
                                style="box-sizing: border-box;font-weight: bolder;"><?php echo esc_html(esc_html(get_bloginfo('url'))) ?></strong>
                    </div>
                </div>
                ...
                <div class="mt-4 col-xl-2 col-lg-2 col-md-12 col-sm-12 d-flex justify-content-lg-end justify-content-md-center justify-content-xs-start"
                    ...
                    <div class="row align-items-center"
                        ...
                        <div class="col-auto"
                            ...
                            <img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?php echo str_replace(' ', '', esc_html($taxServiceReportDecoded['qr'])) ?>"
                                 class="img-fluid" alt=""
            ...
            <div class="row"
                ...
                <div class="mt-12 col-xl-12 col-lg-12 col-md-12 col-sm-12"
                     style="box-sizing: border-box;position: relative;width: 100%;min-height: 1px;padding-right: 15px;padding-left: 15px;-ms-flex: 0 0 100%;flex: 0 0 100%;max-width: 100%;">
                    <div style="box-sizing: border-box;">Կտրոնի վերադարձի ամիս ամսաթիվ ու ժամ։
                        <strong style="box-sizing: border-box;font-weight: bolder;"><?php echo date("Y-m-d H:i:s", substr(esc_html($taxServiceReportDecoded['time']), 0, 10)) ?></strong>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3"
                ...
                <div class="col-lg-4 col-sm-5"
                    ...
                    <strong style="box-sizing: border-box;font-weight: bolder;">Վերադարձ (Ֆ)</strong></div>
